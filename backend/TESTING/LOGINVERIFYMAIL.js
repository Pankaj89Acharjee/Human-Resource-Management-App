...
const verifyEmail = (tomail, subject, textmessage, item ) => {
    ...
    const mailOptions = {
        from: `Server Monitoring ${process.env.MAIL_FROM}`, // sender address
        to: tomail, // list of receivers
        subject: subject, // Subject line
        text: textmessage, // plain text body
        html: '<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2"> <div style="margin:50px auto;width:70%;padding:20px 0"> <div style="border-bottom:1px solid #eee"> <a href="" style="font-size:1.4em;color: #00466A;text-decoration:none;font-weight:600">HashCash Consultants</a> </div><p style="font-size:1.1em">Hi,</p><p>Thank you for Logging. Use the following OTP to complete your Sign In procedures. OTP is valid for 5 minutes</p><h2 style="background: #00466A;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">'+ item.otp +'</h2> <hr style="border:none;border-top:1px solid #eee"/> <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300"> <p>HashCash Consultants</p><p>2100 Geng Road, Palo Alto</p><p>California</p></div></div></div>',
    };
